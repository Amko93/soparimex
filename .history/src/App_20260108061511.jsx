...
import ProductDetailsPage from './pages/ProductDetailsPage'; // <--- VERIFIE QUE CETTE LIGNE EST LA
...
// ... tes imports ...
import SearchResultsPage from './pages/SearchResultsPage'; // <--- NOUVEL IMPORT
