...
import { Mail, Building, X, Trash2, Eye, CheckCircle, Clock } from 'lucide-react';
...
const AdminMessagesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-site p-6 font-sans">
        ...
        <div className="bg-white rounded-[2rem] shadow-xl border border-slate-100 overflow-hidden min-h-[400px]">
          {loading ? (
            ...
            <div className="p-20 text-center flex flex-col items-center gap-4">
              <p className="text-slate-600 font-medium">Impossible de charger les messages.</p>
              <button onClick={fetchMessages} className="px-6 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition">
                Réessayer
              </button>
            </div>
          ) : messages.length === 0 ? (
