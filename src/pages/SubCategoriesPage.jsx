  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 font-sans min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        {session && (
          <div onClick={openCreateModal} className="min-h-[300px] border-2 border-dashed border-blue-200 bg-blue-50/30 rounded-3xl flex flex-col items-center justify-center cursor-pointer hover:bg-blue-50 hover:border-blue-500 transition-all text-blue-500 group gap-3">
