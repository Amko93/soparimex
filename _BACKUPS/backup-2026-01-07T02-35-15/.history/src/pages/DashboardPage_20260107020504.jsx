          ...
          <form onSubmit={handleUpdateProfile} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <input type="text" maxLength="10" value={profile.phone} onChange={(e) => setProfile({...profile, phone: e.target.value.replace(/\D/g, '')})} className="w-full border border-slate-200 rounded-xl px-4 py-3.5" placeholder="Numéro" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input type="text" maxLength="5" value={profile.zip_code} onChange={(e) => setProfile({...profile, zip_code: e.target.value.replace(/\D/g, '')})} className="w-full border border-slate-200 rounded-xl px-4 py-3.5" placeholder="93000" />
              </div>

              {/* Ville */}
              <div className="space-y-2">
                <label className="text-sm font-bold text-slate-500">Ville</label>
                <input type="text" value={profile.city} onChange={(e) => setProfile({...profile, city: e.target.value})} className="w-full border border-slate-200 rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Ville" />
              </div>
