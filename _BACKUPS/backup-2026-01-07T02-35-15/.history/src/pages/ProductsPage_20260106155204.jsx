...
const ProductsPage = () => {
  ...
  // Champs du Formulaire (Modifié : plus de prix/stock, ajout du code)
  const [formData, setFormData] = useState({
    name: '',
    description: '',
    product_code: '', // Nouveau champ
    image: null
  });
  ...
  const openCreateModal = () => {
    ...
    // On réinitialise le formulaire avec le code produit
  ...
  const openEditModal = (e, prod) => {
    ...
    setFormData({
      ...
      product_code: prod.product_code || '', // On charge le code existant
      image: null
    });
    setShowModal(true);
  };
  ...
  const handleSave = async (e) => {
    ...
    // Préparation des données pour la base (Sans prix ni stock, avec product_code)
    const productData = {
      name: formData.name,
      description: formData.description,
      product_code: formData.product_code, // Envoi du code
