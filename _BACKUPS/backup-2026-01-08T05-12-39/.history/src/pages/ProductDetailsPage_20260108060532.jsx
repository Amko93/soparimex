...
const ProductDetailsPage = () => {
  ...
  const fetchProduct = async () => {
    setLoading(true);
    try {
      // On récupère le produit et on joint la sous-catégorie pour le bouton retour
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 font-sans min-h-screen">
      {/* Bouton Retour (Tente de revenir à la sous-catégorie, sinon aux catégories) */}
      <Link 
      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-slate-100 flex flex-col md:flex-row min-h-[500px]">
        ...
        <div className="w-full md:w-1/2 p-10 md:p-14 flex flex-col justify-center">
          ...
          {/* Code Produit (Visible SEULEMENT s'il n'est pas vide) */}
