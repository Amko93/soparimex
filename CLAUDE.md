# CLAUDE.md — Soparimex · Guide de développement
...
-- Envoi public (sans connexion — la page Contact nécessite connexion côté frontend)
CREATE POLICY "Envoi messages public"
